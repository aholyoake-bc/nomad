...
func (j *Jobs) PlanOpts(job *Job, opts *PlanOptions, q *WriteOptions) (*JobPlanResponse, *WriteMeta, error) {
	...
	if opts != nil {
		req.Diff = opts.Diff
		req.LogSchedulerEvents = opts.LogSchedulerEvents
		req.PolicyOverride = opts.PolicyOverride
	}
...
type JobPlanResponse struct {
	...
	// SchedulerWarnings contains any warnings generated by the scheduler that
	// are not necessaryly related to any placement or task groups.
